...
pub type TrustedTeleporters = (
    staging_xcm_builder::Case<RocForTick>,
    staging_xcm_builder::Case<RocForTrick>,
    staging_xcm_builder::Case<RocForTrack>,
    staging_xcm_builder::Case<RocForAssetHub>,
    staging_xcm_builder::Case<RocForContracts>,
    staging_xcm_builder::Case<RocForEncointer>,
    staging_xcm_builder::Case<RocForBridgeHub>,
    staging_xcm_builder::Case<RocForPeople>,
    staging_xcm_builder::Case<RocForBroker>,
);
